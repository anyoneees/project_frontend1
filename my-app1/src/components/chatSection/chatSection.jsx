...
function ChatSection() {
    const [chats, setChats] = useState([
        ...
        },
        {
            id: 2,
            name: "Мария Сидорова",
            lastMessage: "Здравствуйте, вы отдаете кукольный домик? Хотела взять для дочки, очень люит куклы.",
            time: "10:45",
            unread: 0,
            avatar: "https://i.pravatar.cc/150?img=2",
            online: true,
            personality: "Ты Мария Сидорова, хочешь получить кукольный домик для дочки."
        },
        {
            id: 3,
            name: "Алексей Иванов",
            ...
            online: true,
            personality: "Ты Алексей Иванов, продавец шубы, расскажи что отдаешь норковую шубу жены."
        }
    ]);
