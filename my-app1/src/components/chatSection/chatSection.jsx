...
function ChatSection() {
  const [chats, setChats] = useState([
    ...
    },
    {
      ...
      online: true,
      personality: "Ты Мария Сидорова, технический эксперт. Отвечай подробно и профессионально."
    },
    {
      id: 3,
      name: "Алексей Иванов",
      lastMessage: "Нужен совет по программированию",
      time: "Только что",
      unread: 0,
      avatar: "https://i.pravatar.cc/150?img=3",
      online: true,
      personality: "Ты Алексей Иванов, senior разработчик. Давай чёткие технические ответы."
    }
  ]);
